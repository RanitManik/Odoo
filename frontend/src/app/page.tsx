...
export default async function LandingPage() {
  ...
  return (
    <div className="flex h-[100svh] flex-col bg-[#FAFAFA] font-sans selection:bg-purple-300">
      {/* Navigation */}
      <header className="flex items-center justify-between border-b-4 border-gray-900 bg-white px-8 py-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-10">
      ...
      <main className="relative flex flex-1 flex-col items-center justify-center overflow-hidden p-8">
        ...
        <div className="z-10 flex max-w-4xl flex-col items-center text-center">
          <div className="mb-6 inline-flex border-2 border-gray-900 bg-yellow-300 px-4 py-1 text-sm font-black uppercase tracking-wider text-gray-900 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            Enterprise Asset Management
          </div>
          <h1 className="mb-8 text-5xl font-black leading-tight tracking-tight text-gray-900 md:text-7xl">
          ...
          <p className="mb-12 max-w-2xl text-lg font-medium text-gray-700 md:text-xl">
            AssetFlow simplifies how organizations manage physical assets and shared resources through a centralized, brutally efficient ERP platform. No more spreadsheets.
          </p>
      ...
      <div className="z-10 flex flex-col items-center justify-center gap-8 border-t-4 border-gray-900 bg-white p-8 md:flex-row md:gap-16">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-bold text-gray-900">Asset Tracking</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-bold text-gray-900">Resource Booking</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-bold text-gray-900">Role-Based Auth</span>
        </div>
      </div>
    </div>
  );
